    ...
    >
      ...
      <div class="el-progress-bar">
        ...
        >
          ...
          <div class="el-progress-bar__inner" :style="barStyle2" v-if="percentageValue[1]">
            <div
      ...
      <div class="contener ">
        <div>
          <span>当前调用量:{{ percentageValue[0] }}次</span>
        </div>
        <div v-if="percentageValue[1]">
          <span>总共调用量:{{ percentageValue[1] }}次</span>
        </div>
      </div>
    </div>
  </div>
